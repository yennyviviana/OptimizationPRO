...
mysqli_set_charset($mysqli, 'utf8');
    ...
    $resultado = $modelo->insertarPedido($nombre_pedido, $precio, $estado, $direccion, $descripcion, $numero_seguimiento, $tiempo_entrega_horas,$metodo_pago, $archivo, $fecha_pedido, $fecha_entrega, $id_usuario);
