...
?>
    ...
    <td><?php echo htmlspecialchars($producto['nombre_producto']); ?></td>
       ...
       <td><img src="../../public/img/Catalogo/<?php echo $producto['archivo']; ?>" width="150" alt=""></td>
       <td><?php echo htmlspecialchars($producto['id_proveedor']); ?></td>
        ...
        <td>
                ...
                <!-- Botón de Borrar -->
<a href="#" class="btn btn-danger btn-borrar" onclick="borrarProducto(<?php echo $producto['id_producto']; ?>)">
