        ...
        <div id="form-background">
            ...
            <form action="edit.php?lla=<?php echo $llave; ?>" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                <div class="form-group">
                    ...
                    <input type="text" id="nombre_pedido" name="nombre_pedido" value="<?php echo htmlspecialchars($producto['nombre_producto']); ?>" class="form-control" required placeholder="Ingresar nombre pedido">
                ...
                <select id="estado" name="estado" required class="form-control">
                    <option value="aprobado" <?php if ($producto['estado'] == 'aprobado') echo 'selected'; ?>>Aprobado</option>
                    <option value="cancelado" <?php if ($producto['estado'] == 'cancelado') echo 'selected'; ?>>Cancelado</option>
                    <option value="en stock" <?php if ($producto['estado'] == 'en stock') echo 'selected'; ?>>En stock</option>
                </select>
                
                <div class="form-group">
                    <label for="direccion">Direccion</label>
                    <input type="text" id="direccion" name="direccion" value="<?php echo htmlspecialchars($producto['direccion']); ?>" class="form-control" required placeholder="Ingresar direccion">
                    <div class="invalid-feedback">Por favor ingrese la direccion.</div>
                </div>

                <div class="form-group">
                    <label for="descripcion">Descripcion</label>
                    <textarea id="descripcion" name="descripcion" class="form-control" required placeholder="Descripcion"><?php echo htmlspecialchars($producto['descripcion']); ?></textarea>
                    <div class="invalid-feedback">Por favor ingrese la descripcion.</div>
                </div>

                <div class="form-group">
                    <label for="numero_seguimiento">Numero seguimiento</label>
                    <input type="number" id="numero_seguimiento" name="numero_seguimiento" value="<?php echo htmlspecialchars($producto['numero_seguimiento']); ?>" class="form-control" required placeholder="Numero seguimiento">
                    <div class="invalid-feedback">Numero de seguimiento.</div>
                </div>

                <div class="form-group">
                    <label for="informacion_pedido">Información:</label>
                    <textarea id="informacion_pedido" name="informacion_pedido" class="form-control" required placeholder="Información"><?php echo htmlspecialchars($producto['informacion_pedido']); ?></textarea>
                ...
                <select id="metodo_pago" name="metodo_pago" required class="form-control">
                    <option value="credito" <?php if ($producto['metodo_pago'] == 'credito') echo 'selected'; ?>>Credito</option>
                    <option value="Paypal" <?php if ($producto['metodo_pago'] == 'Paypal') echo 'selected'; ?>>Paypal</option>
                    <option value="transferencia" <?php if ($producto['metodo_pago'] == 'transferencia') echo 'selected'; ?>>Transferencia</option>
                </select>
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="fecha_entrega" name="fecha_entrega" value="<?php echo htmlspecialchars($producto['fecha_entrega']); ?>" class="form-control" required>
                </div>

                <div class="form-group">
                    <label>Tiempo transcurrido (Días y Horas):</label>
                    <span id="tiempo_entrega_horas" class="form-control"><?php echo htmlspecialchars($producto['tiempo_entrega_horas']); ?></span>
                </div>

                <input type="hidden" name="id_pedido" value="<?php echo htmlspecialchars($producto['id_pedido']); ?>">
